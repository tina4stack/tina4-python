...
`;function $t(e){e.innerHTML=`
  ...
  `).join(""))}window.__loadRoutes=Ve;let Q=[],U=[],O=JSON.parse(localStorage.getItem("tina4_query_history")||"[]");function kt(e){e.innerHTML=`
    <div class="dev-panel-header">
      <h2>Database</h2>
