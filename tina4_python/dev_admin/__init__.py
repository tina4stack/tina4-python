...
<div class="dev-header">
    <img src="https://tina4.com/logo.svg" style="width:1.5rem;height:1.5rem" alt="Tina4">
...
<div id="panel-queue" class="dev-panel hidden">
    ...
    <div class="toolbar">
        <button class="btn btn-sm filter-btn active" onclick="filterQueue('')">All</button>
        <button class="btn btn-sm filter-btn" onclick="filterQueue('pending')">Pending <span id="q-pending">0</span></button>
        <button class="btn btn-sm filter-btn" onclick="filterQueue('completed')">Done <span id="q-completed">0</span></button>
        <button class="btn btn-sm filter-btn" onclick="filterQueue('failed')">Failed <span id="q-failed">0</span></button>
        <button class="btn btn-sm filter-btn" onclick="filterQueue('reserved')">Active <span id="q-reserved">0</span></button>
    </div>
    <table>
...
<div id="panel-mailbox" class="dev-panel hidden">
    ...
    <div class="toolbar">
        <button class="btn btn-sm filter-btn active" onclick="filterMailbox('')">All</button>
        <button class="btn btn-sm filter-btn" onclick="filterMailbox('inbox')">Inbox</button>
        <button class="btn btn-sm filter-btn" onclick="filterMailbox('outbox')">Outbox</button>
    </div>
...
<script>
// Dev Admin — vanilla JS, zero dependencies, cross-language
